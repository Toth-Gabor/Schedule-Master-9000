...
public final class DatabaseUserDao extends AbstractDao implements UserDao {
    ...
    public List<User> findAll() throws SQLException {
        String sql = "SELECT user_id, user_name, administrator, email, user_password FROM users";
    ...
    public List<User> findAllAdmin(boolean admin) throws SQLException {
        String sql = "SELECT user_id, user_name, administrator, email, user_password FROM users where administrator =?";
    ...
    public User findByEmail(String email) throws SQLException {
        ...
        String sql = "SELECT user_id, user_name, administrator, email, user_password FROM users WHERE email = ?";
        try (PreparedStatement statement = connection.prepareStatement(sql)) {
